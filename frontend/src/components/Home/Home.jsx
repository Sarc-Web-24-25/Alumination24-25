...
export default function Home() {
  ...
  const ScrollComponent =
    windowDimensions.width <= 768 ? null : HorizontalScroll;

  return (
    <div style={containerStyle}>
      <CursorAnimation />
      {ScrollComponent ? (
        <ScrollComponent reverseScroll={true}>
            ...
            <div style={bgstyle}>
              <div style={imgDivStyle}>
                ...
                <img
                  width={"40%"}
                  src={sarc}
                  style={{ position: "absolute", top: "23%", left: "13%" }}
                  alt=""
                />
              </div>
              ...
              <div id="about" style={aboutus}>
                ...
                <p style={textstyle1}>
                  SARC proudly presents Alumination 2023, IIT Bombay's grandest
                  student-alumni fest. This two-day extravaganza aims to quench
                  your thirst for knowledge, harness the wisdom of our esteemed
                  alumni, and create a bridge between students and our vast
                  alumni network. With a diverse array of activities catering to
                  interests in core, non-core, and unconventional fields,
                  Alumination invites you to transform aspirations into
                  achievements. Join us on October 21st and 22nd to let your
                  dreams take flight and reunite with beloved alumni at their
                  alma mater!
                </p>
              </div>
              ...
              <div style={{ marginTop: "-30px" }}>
                <div style={hcontain}>
                  <img src={glass} style={imgstyle4} alt="" />{" "}
                  <span style={textstyle3}> PAST SPEAKERS </span>{" "}
                  <img src={glass} style={imgstyle4} alt="" />
                </div>
                <div style={hcontain}>
                  <div style={frame1}>
              ...
              >
                <div style={hcontain}>
                  {" "}
                  <span className="heightFont" style={textstyle}>
                    {" "}
                    OUR SPONSORS{" "}
                  </span>
                </div>
                <div style={hcontain}>
                  <a
                    className="link-sponsor-underline"
                    href="https://bit.ly/48VNI3l"
                  >
                    <div style={frame2}>
                      {" "}
                      <img
                ...
                <div style={hcontain}>
                  ...
                  <a
                    className="link-sponsor-underline"
                    href="https://www.instagram.com/cdslindia/"
                  >
                    <div style={frame2}>
                      {" "}
                      <img
              ...
              <div style={{ marginTop: "-10vh", marginLeft: "70px" }}>
                ...
                <div style={hcontain}>
                  ...
                  <a
                    className="link-sponsor-underline"
                    href="https://www.vskills.in/certification/"
                  >
                    <div style={frame2}>
                      {" "}
                      <img
                  ...
                  <a
                    className="link-sponsor-underline"
                    href="https://www.mycampusstudyabroad.com/"
                  >
                    <div style={frame2}>
                      {" "}
                      <img
              ...
              <div style={{ marginTop: "-10vh", marginLeft: "70px" }}>
                ...
                <div style={hcontain}>
                  <a className="link-sponsor-underline" href="#">
                    <div style={frame2}>
                      {" "}
                      <img
                        src={sp10}
                ...
                <div style={hcontain}>
                  ...
                  <a
                    className="link-sponsor-underline"
                    href="https://www.instagram.com/neomediaworks/?hl=en"
                  >
                    <div style={frame2}>
                      {" "}
                      <img
              ...
              >
                ...
                <div style={hcontain}>
                  ...
                  <a
                    className="link-sponsor-underline"
                    href="https://instagram.com/harryandkarryfoods?igshid=MzRlODBiNWFlZA=="
                  >
                    <div style={frame2}>
                      {" "}
                      <img
        ...
        <div style={{ ...childStyle, overflowX: "hidden !important" }}>
          <div
            className="bgstyle"
            style={{ ...bgstyle, overflowX: "hidden !important" }}
          >
            ...
            <div
              className="aboutus"
              style={{ ...aboutus, textAlign: "center" }}
            >
              <h1 style={textstyle}>ABOUT US</h1>
              <p className="aboutuspara" style={textstyle1}>
                SARC proudly presents Alumination 2023, IIT Bombay's grandest
                student-alumni fest. This two-day extravaganza aims to quench
                your thirst for knowledge, harness the wisdom of our esteemed
                alumni, and create a bridge between students and our vast alumni
                network. With a diverse array of activities catering to
                interests in core, non-core, and unconventional fields,
                Alumination invites you to transform aspirations into
                achievements. Join us on October 21st and 22nd to let your
                dreams take flight and reunite with beloved alumni at their alma
                mater!
              </p>
            </div>
            <img src={ig1} style={imgstylegod} alt="" />
            <div className="speakers" style={{ marginTop: "-30px" }}>
              <div style={hcontain}>
                <img src={glass} style={imgstyle4} alt="" />{" "}
                <span className="speaker-heading" style={textstyle3}>
                  {" "}
                  PAST SPEAKERS{" "}
                </span>{" "}
                <img src={glass} style={imgstyle4} alt="" />
              ...
              <div className="main-con" style={hcontain}>
                <div className="con-main" style={frame1}>
                  {" "}
                  <img
                    src={nandan}
                    alt=""
                    style={{ width: "85vw", marginTop: "30px" }}
                  />{" "}
                  <span
                    style={{
                      color: "#FFD6A0",
            ...
            <img
              className="wobble-hor-top clock-apni"
              src={clock}
              style={imgstyle1}
              alt=""
            />
              ...
              <div className="image-apni" style={hcontain}>
                <div className="image-apni">
                  <div className="image-apni" style={clock1}>
                    <span style={textstyle2}>
                      {counterOn && (
                        <CountUp start={0} end={1000} duration={5} delay={5} />
                      )}{" "}
                      +
                    </span>
                  </div>
         ...
         <div style={clock1}>
            ...
            <div className="sponsors">
              <div className="speaker-heading" style={hcontain}>
                {" "}
                <span style={{ ...textstyle, fontSize: "50px" }}>
                  {" "}
                  OUR SPONSORS{" "}
                </span>
              </div>
                ...
                >
                  <div style={{ ...frame2 }}>
                    ...
                    <img
                      src={sp1}
                      alt=""
                      style={{ width: "90vw", textDecoration: "none" }}
                    />{" "}
                    <span
                      style={{
                        color: "#FFD6A0",
              ...
              <div style={{ marginLeft: "2vw" }}>
                <a
                  ...
                  href="https://www.bankofbaroda.in/"
                >
                  <div style={{ ...frame2, marginBottom: "25vh" }}>
                    {" "}
                    <img src={sp2} alt="" style={{ width: "90vw" }} />{" "}
                    <span
                      style={{
                        color: "#FFD6A0",
                        fontSize: "25px",
                ...
                >
                  <div style={frame2}>
                    {" "}
                    <img src={sp3} alt="" style={{ width: "90vw" }} />{" "}
                    <span
                      style={{
                        color: "#FFD6A0",
                        fontSize: "25px",
            ...
            <div style={{ marginTop: "2vh" }} className="sponsors">
              <div className="speaker-heading" style={hcontain}>
                {" "}
                <span style={textstyle}> OUR PARTNERS </span>
              </div>
              ...
              >
                ...
                >
                  {" "}
                  <img src={sp4} alt="" style={{ width: "90vw" }} />{" "}
                  <span
                    style={{
                      color: "#FFD6A0",
                      fontSize: "25px",
              ...
              >
                ...
                >
                  {" "}
                  <img src={sp5} alt="" style={{ width: "90vw" }} />{" "}
                  <span
                    style={{
                      color: "#FFD6A0",
                      fontSize: "25px",
              ...
              >
                ...
                >
                  {" "}
                  <img src={sp6} alt="" style={{ width: "90vw" }} />{" "}
                  <span
                    style={{
                      color: "#FFD6A0",
                      fontSize: "25px",
              ...
              <a className="link-sponsor-underline" href="#">
                ...
                >
                  {" "}
                  <img src={sp7} alt="" style={{ width: "90vw" }} />{" "}
                  <span
                    style={{
                      color: "#FFD6A0",
                      fontSize: "25px",
              ...
              <a className="link-sponsor-underline" href="#">
                ...
                >
                  {" "}
                  <img src={sp25} alt="" style={{ width: "90vw" }} />{" "}
                  <span
                    style={{
                      color: "#FFD6A0",
                      fontSize: "25px",
              ...
              <a className="link-sponsor-underline" href="#">
                ...
                >
                  {" "}
                  <img src={sp26} alt="" style={{ width: "90vw" }} />{" "}
                  <span
                    style={{
                      color: "#FFD6A0",
                      fontSize: "25px",
              ...
              >
                ...
                >
                  {" "}
                  <img src={sp9} alt="" style={{ width: "90vw" }} />{" "}
                  <span
                    style={{
                      color: "#FFD6A0",
                      fontSize: "25px",
            ...
            <div className="speakers">
              <div className="speaker-heading" style={hcontain}>
                {" "}
                <span style={textstyle}> MEDIA PARTNER </span>
              </div>
              ...
              <div>
                <a className="link-sponsor-underline" href="#">
                  ...
                  >
                    {" "}
                    <img src={sp10} alt="" style={{ width: "90vw" }} />{" "}
                    <span
                      style={{
                        color: "#FFD6A0",
                        fontSize: "25px",
                ...
                >
                  ...
                  >
                    {" "}
                    <img src={sp21} alt="" style={{ width: "90vw" }} />{" "}
                    <span
                      style={{
                        color: "#FFD6A0",
                        fontSize: "25px",
                ...
                >
                  ...
                  >
                    {" "}
                    <img src={sp27} alt="" style={{ width: "90vw" }} />{" "}
                    <span
                      style={{
                        color: "#FFD6A0",
                        fontSize: "25px",
            ...
            <div style={{ marginTop: "2vh" }} className="sponsors">
              <div className="speaker-heading" style={hcontain}>
                {" "}
                <span style={textstyle22}> FOOD & BEVERAGES PARTNER </span>
              </div>
              <a
                className="link-sponsor-underline"
                href="https://g.co/kgs/cGcEnx"
              >
                ...
                >
                  {" "}
                  <img src={sp22} alt="" style={{ width: "90vw" }} />{" "}
                  <span
                    style={{
                      color: "#FFD6A0",
                      fontSize: "25px",
              ...
              <a className="link-sponsor-underline" href="#">
                ...
                >
                  {" "}
                  <img src={sp23} alt="" style={{ width: "90vw" }} />{" "}
                  <span
                    style={{
                      color: "#FFD6A0",
                      fontSize: "25px",
              ...
              >
                ...
                >
                  {" "}
                  <img src={sp24} alt="" style={{ width: "90vw" }} />{" "}
                  <span
                    style={{
                      color: "#FFD6A0",
                      fontSize: "25px",
